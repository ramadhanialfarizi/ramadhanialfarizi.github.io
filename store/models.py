...
class Address(models.Model):
    ...
    locality = models.CharField(max_length=150, verbose_name="Lokasi Sekitar")
    city = models.CharField(max_length=150, verbose_name="Kota")
    state = models.CharField(max_length=150, verbose_name="Provinsi")
